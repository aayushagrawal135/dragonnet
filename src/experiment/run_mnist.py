...
def train_and_predict_dragons(t_train, t_test, y_train, y_test, x_train, x_test, targeted_regularization=True, output_dir='',
    ...
    ## TODO: might need to change y_train and t_train to numpy
    ...
    dragonnet.compile(optimizer=SGD(learning_rate = sgd_lr, momentum=momentum, nesterov=True), loss=loss,
                      metrics=metrics)
    # TODO: need to change last layer to do classification
...
def run_mnist(output_dir='~/result/ihdp/', knob_loss=dragonnet_loss_binarycross, ratio=1., dragon=''):
    ...
    for idx, simulation_file in enumerate(simulation_files):
        ...
        for is_targeted_regularization in [True, False]:
            ...
            ## TODO: get outputs - how to save outputs
...
def turn_knob(knob='dragonnet', output_base_dir=''):
...
def main():
    ...
    turn_knob(args.knob, args.output_base_dir)
